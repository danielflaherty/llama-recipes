...
class train_config:
    ...
    use_peft: bool=False
    output_dir: str = "/home/checkpoints/reasoning_no_loss_epoch_3_sft_all_qs"
    ...
    dist_checkpoint_root_folder: str="/home/checkpoints/reasoning_no_loss_epoch_3_sft_all_qs/FSDP/model" # will be used if using FSDP
    ...
    wandb_run_name: str = "reasoning_no_loss_epoch_3_sft_all_qs"
    logging_steps: int = 2
