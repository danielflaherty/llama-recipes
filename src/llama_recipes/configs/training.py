...
class train_config:
    ...
    use_peft: bool=False
    output_dir: str = "/home/checkpoints/wiki-india-full-ft_1e-4_beta2_0.95_warmup_0.02"
    ...
    save_factor: int = 2 # Factor of an epoch to save model
    dist_checkpoint_root_folder: str="/home/checkpoints/wiki-india-full-ft_1e-4_beta2_0.95_warmup_0.02/FSDP/model" # will be used if using FSDP
    ...
    wandb_run_name: str = "wiki-india-full-ft_1e-4_beta2_0.95_warmup_0.02"
    logging_steps: int = 5
