...
class train_config:
    ...
    use_peft: bool=False
    output_dir: str = "/home/checkpoints/wiki-india-full-ft"
    freeze_layers: bool = False
    num_freeze_layers: int = 1
    quantization: bool = False
    one_gpu: bool = False
    save_model: bool = True
    dist_checkpoint_root_folder: str="/home/checkpoints/wiki-india-full-ft/FSDP/model" # will be used if using FSDP
    ...
    wandb_run_name: str = "wiki-india-run-2"
