...
class train_config:
    ...
    use_peft: bool=False
    output_dir: str = "/home/checkpoints/reasoning_wiki_all_epoch_3_sft_byjus_all"
    freeze_layers: bool = False
    num_freeze_layers: int = 1
    quantization: bool = False
    one_gpu: bool = False
    checkpoint_path: str = "/home/checkpoints/fixed_ckpt_wiki-india-full-ft_1e-4_beta2_0.95_warmup_0.02/FSDP/model/ft-model-NousResearch/Llama-2-7b-hf-epoch_2" # If not -1, start training again from the checkpoint at this epoch
    optimizer_checkpoint_path: str = "" # If not empty string, start training again from this checkpoint
    save_model: bool = False
    dist_checkpoint_root_folder: str="/home/checkpoints/reasoning_wiki_all_epoch_3_sft_byjus_all/FSDP/model" # will be used if using FSDP
    ...
    wandb_run_name: str = "reasoning_wiki_all_epoch_3_sft_byjus_all"
    logging_steps: int = 2
